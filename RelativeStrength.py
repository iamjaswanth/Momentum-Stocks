...
# Variables
tickers = pd.read_excel('/Users/apple/Downloads/MCAP31032021_0.xlsx')
tickers['capitalization'] = pd.to_numeric(tickers['Market capitalization \n(Rs in Lakhs)'],errors='coerce')
tickers = tickers[tickers['capitalization'] < 200000.0]

#ind_nifty200list
#ind_niftysmallcap250list
#ind_niftysmallcap100list
tickers = pd.read_csv('/Users/apple/Downloads/ind_niftymidsmallcap400list.csv')
